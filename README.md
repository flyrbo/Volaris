...
* Do **not** use this in public games without permission.
* Do **not** use this to harm other players or disrupt gameplay.
* Respect developers and the Roblox community.

---

## ⚙️ Requirements

This script requires an executor that supports the following functions:
...
* These features are commonly found in **mid to high-level executors**.
* Lack of support for any of the above required functions may cause parts of the script to break or not run at all.
* Compatibility may vary depending on executor updates and the game environment.
